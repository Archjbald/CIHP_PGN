...
def read_images_from_disk(input_queue, input_size, random_scale,
    ...
    edge_contents = tf.io.read_file(input_queue[3])
...
class ImageReaderPGN(object):
    ...
    def __init__(self, data_dir, data_list, data_id_list, input_size, random_scale,
        ...
        self.image_list, self.label_list, self.label_rev_list = read_labeled_image_reverse_list(self.data_dir,
                                                                                                self.data_list)
        ...
        self.queue = tf.compat.v1.train.slice_input_producer([self.images, self.labels, self.labels_rev, self.edges],
                                                   shuffle=shuffle)
    ...
    def dequeue(self, num_elements):
        ...
        image_batch, label_batch, edge_batch = tf.compat.v1.train.batch([self.image, self.label, self.edge],
                                                                        num_elements)
